...
Created to allow running very specific commands against the database to improve data quality
"""
...
#             print(track[2])
#         # try:
#             dbcur.db.execute("UPDATE tracks SET lowercase_track_title = (?) WHERE track_title = (?) AND album_id = (?)", (track[2][:paren_locator], track[2], track[3]))
#             dbcur.commit()
